...
int main(int ac, char **av)
{
	...
	if (threadcount == 0) {
		...
		std::thread tm3(slidingWindowScan, std::ref(gv.dd.instListThirdPartition),
			...
			gv.colEndIdx, 10, 10, rowStep, colStep,std::ref(logs2),std::ref(numCellsMovedThirdPartition),std::ref(numPredictionTrialsThirdPartition),std::reference_wrapper<const fdeep::model>(model1));
		...
		std::thread tm4(slidingWindowScan, std::ref(gv.dd.instListFourthPartition),
			...
			gv.colEndIdx, 10, 10, rowStep, colStep,std::ref(logs3),std::ref(numCellsMovedFourthPartition),std::ref(numPredictionTrialsFourthPartition),std::reference_wrapper<const fdeep::model>(model1));
		...
		cout << "numPredictionTrials = " << numPredictionTrialsSecondPartition + numPredictionTrialsFirstPartition + numPredictionTrialsThirdPartition +numPredictionTrialsFourthPartition /*+numPredictionTrialsFifthPartition+numPredictionTrialsSixthPartition+numPredictionTrialsSeventhPartition+numPredictionTrialsEighthPartition*/<< endl;
		cout << "numCell moved = " << numCellsMovedFirstPartition + numCellsMovedSecondPartition + numCellsMovedThirdPartition + numCellsMovedFourthPartition << endl;
		...
		std::thread tm4(slidingWindowScan, std::ref(gv.dd.instListFourthPartition),
			fourthPartitionStart,  gv.colBeginIdx, fourthPartitionEnd,
			gv.colEndIdx, 10, 10, rowStep, colStep,std::ref(logs3),std::ref(numCellsMovedFourthPartition),std::ref(numPredictionTrialsFourthPartition),std::reference_wrapper<const fdeep::model>(model1));
		std::thread tm5(slidingWindowScan, std::ref(gv.dd.instListFifthPartition), fifthPartitionStart, gv.colBeginIdx, fifthPartitionEnd,
				gv.colEndIdx, 10 ,10,rowStep,colStep ,std::ref(logs4),std::ref(numCellsMovedFifthPartition),std::ref(numPredictionTrialsFifthPartition),std::reference_wrapper<const fdeep::model>(model1));

		std::thread tm6(slidingWindowScan, std::ref(gv.dd.instListSixthPartition), sixthPartitionStart, gv.colBeginIdx, sixthPartitionEnd,
				gv.colEndIdx, 10 ,10,rowStep,colStep ,std::ref(logs5),std::ref(numCellsMovedSixthPartition),std::ref(numPredictionTrialsSixthPartition),std::reference_wrapper<const fdeep::model>(model1));			
		std::thread tm7(slidingWindowScan, std::ref(gv.dd.instListSeventhPartition), seventhPartitionStart, gv.colBeginIdx, seventhPartitionEnd,
				gv.colEndIdx, 10 ,10,rowStep,colStep ,std::ref(logs6),std::ref(numCellsMovedSeventhPartition),std::ref(numPredictionTrialsSeventhPartition),std::reference_wrapper<const fdeep::model>(model1));
	    std::thread tm8(slidingWindowScan, std::ref(gv.dd.instListEighthPartition), eighthPartitionStart, gv.colBeginIdx, eighthPartitionEnd,
				gv.colEndIdx, 10 ,10,rowStep,colStep ,std::ref(logs7),std::ref(numCellsMovedEighthPartition),std::ref(numPredictionTrialsEighthPartition),std::reference_wrapper<const fdeep::model>(model1));			
		tm1.join();
		tm2.join();
		tm3.join();
		tm4.join();
		...
		cout << "numPredictionTrials in sixth partition = " << numPredictionTrialsSixthPartition << endl;
		cout << "numPredictionTrials in seventh partition = " << numPredictionTrialsSeventhPartition << endl;
		cout << "numPredictionTrials in eighth partition = " << numPredictionTrialsEighthPartition << endl;
		/*cout << "numPredictionTrials in fourth partition = " << numPredictionTrialsFourthPartition << endl;
		cout << "numPredictionTrials in fourth partition = " << numPredictionTrialsFourthPartition << endl;
		cout << "numPredictionTrials in fourth partition = " << numPredictionTrialsFourthPartition << endl;*/
		cout << "numPredictionTrials = " << numPredictionTrialsSecondPartition + numPredictionTrialsFirstPartition + numPredictionTrialsThirdPartition +numPredictionTrialsFourthPartition + numPredictionTrialsFifthPartition+numPredictionTrialsSixthPartition+numPredictionTrialsSeventhPartition+numPredictionTrialsEighthPartition<< endl;
		cout << "numCell moved = " << numCellsMovedFirstPartition + numCellsMovedSecondPartition + numCellsMovedThirdPartition + numCellsMovedFourthPartition + numCellsMovedFifthPartition + numCellsMovedSixthPartition + numCellsMovedSeventhPartition + numCellsMovedEighthPartition<< endl;
	}
			...
			while (getline(ss, tok, ' '))
			{
				...
				if (tok == "GGridBoundaryIdx")
				{
					...
					// ! DOUBT: Why 8 parts?
					{
						...
						firstPartitionEnd = (gv.rowEndIdx / 8);
						secondPartitionStart = firstPartitionEnd + 1;
						secondPartitionEnd =( gv.rowEndIdx/8) * 2;
